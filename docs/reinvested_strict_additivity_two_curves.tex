...
\]
the total output from executing $a$ then $b$.
\end{definition}
...
\begin{tabular}{@{}lclc@{}}
\toprule
\textbf{Type} & \textbf{Condition} & \textbf{Meaning} & \textbf{Path-dep.?} \\
\midrule
Subadditive & $\mathrm{Out}(a{+}b) > \mathrm{Out}_{\mathrm{split}}$ & One-shot better; splitting hurts trader & Yes \\
Strictly additive & $\mathrm{Out}(a{+}b) = \mathrm{Out}_{\mathrm{split}}$ & Split or one-shot identical & No \\
Superadditive & $\mathrm{Out}(a{+}b) < \mathrm{Out}_{\mathrm{split}}$ & Split better; one-shot hurts trader & Yes \\
\bottomrule
\end{tabular}
\end{center}
